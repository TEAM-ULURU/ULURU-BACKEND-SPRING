...
import uluru.uluruspringbackend.common.utils.CookieUtils;
...
public class HttpCookieOAuth2AuthorizationRequestRepository implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public OAuth2AuthorizationRequest loadAuthorizationRequest(HttpServletRequest request) {
        ...
        OAuth2AuthorizationRequest oAuth2AuthorizationRequest =  cookieUtils.getCookie(request, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME)
                ...
                .orElse(null);
        log.info(cookieUtils.getCookie(request, OAUTH2_AUTHORIZATION_REQUEST_COOKIE_NAME).toString());
        log.info(oAuth2AuthorizationRequest.toString());
